...
Yacc 使用的分析算法是 **LALR(1)**——其定义详见 [[编译原理/LR系列对比总览#四、LALR(1)：合并核心相同的 LR(1) 状态|LR 系列对比]]。
...
示例——**Yacc 中的 [[编译原理/关系图谱-节点内容/综合属性|综合属性]]传递即 [[编译原理/关系图谱-节点内容/属性文法|属性文法]]的语义方程**：
...
- [[编译原理/LR系列对比总览]] — LALR(1) 的形式化定义与合并算法
- [[编译原理/语义分析与属性文法]] — 综合/继承属性的理论定义
- [[编译原理/依赖图与属性计算]] — 属性计算的拓扑排序
